...
await client.chat.completions.create({ messages: [{ content: 'create a poem using palindromes', role: 'user' }], model: 'Meta-Llama-3.3-70B-Instruct' }, {
  maxRetries: 5,
});
```
...
1. Via the `SAMBA_NOVA_LOG` environment variable
...
```ts
import SambaNova from 'npm:sambanova';
...
We are keen for your feedback; please open an [issue](https://www.github.com/sambanova/sambanova-typescript/issues) with questions, bugs, or suggestions.
