...
export interface CompletionCreateParamsBase {
  ...
  /**
   * Modify the likelihood of specified tokens appearing in the generation. Accepts a
   * JSON object that maps tokens (specified by their token ID in the model
   * tokenizer) to an associated bias value from -100 to 100. Mathematically, the
   * bias is added to the logits generated by the model prior to sampling. Values
